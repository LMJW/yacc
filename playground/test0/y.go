// Code generated by goyacc -p Calc test0.y. DO NOT EDIT.
...
var CalcAct = [...]int{
	...
	3, 9, 7, 8, 6, 12, 6, 4, 10, 11,
	13, 2, 1, 5,
}
var CalcPact = [...]int{

	-1000, 2, -5, -3, -7, 4, -1000, -1000, 0, 0,
	-1000, -1000, -1000, -3,
}
var CalcPgo = [...]int{
...
//line test0.y:34
		{
			...
			fmt.Printf("%s = %d\n", CalcDollar[1].val, CalcDollar[3].val)
		}
	case 6:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line test0.y:41
